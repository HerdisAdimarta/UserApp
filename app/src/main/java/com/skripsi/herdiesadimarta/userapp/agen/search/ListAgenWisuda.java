...
import com.skripsi.herdiesadimarta.userapp.adapter.RecyclerViewWisuda;
...
public class ListAgenWisuda extends AppCompatActivity implements SearchView.OnQueryTextListener {

    public static final String URL = "http://192.168.100.6/makeup_db_skripsi/";
    private List<Agen> agen = new ArrayList<>();
    private RecyclerViewWisuda viewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewAdapter = new RecyclerViewWisuda(this, agen);
    ...
    private void AmbilDataAgen(){
        ...
        Call<Value> call = api.view_wisuda();
        ...
        call.enqueue(new Callback<Value>() {
            ...
            public void onResponse(Call<Value> call, Response<Value> response) {
                ...
                if(value.equals("1")) {
                    ...
                    viewAdapter = new RecyclerViewWisuda(ListAgenWisuda.this, agen);
                    recyclerView.setAdapter(viewAdapter);
                }
            }
