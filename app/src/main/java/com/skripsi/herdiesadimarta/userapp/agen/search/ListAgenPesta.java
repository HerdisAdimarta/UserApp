...
import com.skripsi.herdiesadimarta.userapp.adapter.RecyclerViewPesta;
...
public class ListAgenPesta extends AppCompatActivity implements SearchView.OnQueryTextListener {

    public static final String URL = "http://192.168.100.6/makeup_db_skripsi/";
    private List<Agen> agen = new ArrayList<>();
    private RecyclerViewPesta viewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewAdapter = new RecyclerViewPesta(this, agen);
    ...
    private void AmbilDataAgen(){
        ...
        Call<Value> call = api.view_pesta();
        ...
        call.enqueue(new Callback<Value>() {
            ...
            public void onResponse(Call<Value> call, Response<Value> response) {
                ...
                if(value.equals("1")) {
                    ...
                    viewAdapter = new RecyclerViewPesta(ListAgenPesta.this, agen);
                    recyclerView.setAdapter(viewAdapter);
                }
            }
