...
import com.skripsi.herdiesadimarta.userapp.booking.ultah.Booking;
...
public class RecyclerViewUltah extends RecyclerView.Adapter<RecyclerViewUltah.ViewHolder> {
    private Context context;
    private List<Agen> agen;

    public RecyclerViewUltah(Context context, List<Agen> agen) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.textViewHargaUltah.setText(agn.getHrg_ultah());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        @BindView(R.id.textHarga)TextView textViewHargaUltah;
        ...
        public void onClick(View v) {
            ...
            b.putString("harga", textViewHargaUltah.getText().toString());
