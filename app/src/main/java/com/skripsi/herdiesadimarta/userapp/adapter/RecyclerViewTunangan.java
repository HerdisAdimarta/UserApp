...
import com.skripsi.herdiesadimarta.userapp.booking.tunangan.Booking;
...
public class RecyclerViewTunangan extends RecyclerView.Adapter<RecyclerViewTunangan.ViewHolder> {
    private Context context;
    private List<Agen> agen;

    public RecyclerViewTunangan(Context context, List<Agen> agen) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.textViewHargaTunangan.setText(agn.getHrg_tunangan());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        @BindView(R.id.textHarga)TextView textViewHargaTunangan;
        ...
        public void onClick(View v) {
            ...
            b.putString("harga", textViewHargaTunangan.getText().toString());
