...
import com.skripsi.herdiesadimarta.userapp.adapter.RecyclerViewUltah;
...
public class ListAgenUltah extends AppCompatActivity implements SearchView.OnQueryTextListener {

    public static final String URL = "http://192.168.100.6/makeup_db_skripsi/";
    private List<Agen> agen = new ArrayList<>();
    private RecyclerViewUltah viewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewAdapter = new RecyclerViewUltah(this, agen);
    ...
    private void AmbilDataAgen(){
        ...
        Call<Value> call = api.view_ultah();
        ...
        call.enqueue(new Callback<Value>() {
            ...
            public void onResponse(Call<Value> call, Response<Value> response) {
                ...
                if(value.equals("1")) {
                    ...
                    viewAdapter = new RecyclerViewUltah(ListAgenUltah.this, agen);
                    recyclerView.setAdapter(viewAdapter);
                }
            }
